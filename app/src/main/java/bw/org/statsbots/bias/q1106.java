...
public class q1106 extends AppCompatActivity implements Serializable {
    ...
    final List <PersonRoster>  roster = myDB.getdataHhP(ind.getAssignmentID(), ind.getBatch());
                        ...
                        switch (v.getId()) {
                            case R.id.q1106_1:
                                if (checked) {
                                    ...
                                    rbtn6b1.setEnabled(false);
                                    rbtn6b2.setEnabled(false);
                                    rbtn6b3.setEnabled(false);
                                    rbtn6b4.setEnabled(false);
                                    rbtn6b5other.setEnabled(false);
                            ...
                            case R.id.q1106_2:
                                ...
                                rbtn6a9.setChecked(false);
                                    ...
                                    rbtn6a1.setEnabled(false);
                                    rbtn6a2.setEnabled(false);
                                    rbtn6a3.setEnabled(false);
                                    rbtn6a9.setEnabled(false);
        ...
        for(int f=0;f<rGroup2.getChildCount();f++)
        {
            ...
            {
                bta[f]=((RadioButton)o);
                if(ind.getQ1106a()!= null )
                {
                    if (f == 3) {
                        rbtn6a9.setChecked(true);
                    }
        ...
        if (ind.getQ1106bOther() != null ) {
            ...
            for (int f = 0; f < rGroup2.getChildCount(); f++) {
                ...
                if (o instanceof RadioButton) {
                    btb[f] = ((RadioButton) o);
                    if (ind.getQ1106b() != null) {
                        if (!ind.getQ1106b().equals("")) {
...
//        }
        ...
        btprev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent intent = new Intent(q1106.this, q1105.class);
                ...
                alertDialogBuilder.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                ...
                                startActivity(intent, ActivityOptions.makeSceneTransitionAnimation(q1106.this).toBundle());
