...
public class Visit2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btndate.setOnClickListener(new Visit2.DateBtnClick());
        btnEndVisits.setOnClickListener(new Visit2.EndIntervieBtn());
        ...
        btnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Visit2.this, MainActivity.class);
        ...
        btnNext.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                if(radiovalue==null)
                {
                    new LibraryClass().showError(Visit2.this,"Visit Result Error","Please select visit result");
                    /**
                     * VIBRATE DEVICE
                     */
                ...
                else
                {
                    ...
                    if(radiovalue.equals("6"))
                    {
                        ...
                        if(s.length()<5)
                        {
                            new LibraryClass().showError(Visit2.this,"Result Code 6. Other Error","Please enter more than 6 characters");
                            /**
                             * VIBRATE DEVICE
                             */
                            Vibrator vibs = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
    ...
    public void onRadioButtonClicked(View view)
    {
        ...
        Intent intentAp = new Intent(Visit2.this,NextVisitAppointment.class);
